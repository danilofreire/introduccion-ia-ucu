...
**[Sesión 5.1: Ética y sesgo algorítmico](clases/dia-05/09-etica-sesgo.html)**

- Tipos de sesgo y cómo surgen
- Métricas de equidad
- Regulación: EU AI Act, legislación latinoamericana, Ley 18.331 (Uruguay)

**[Sesión 5.2: Mini-propuestas de investigación](clases/dia-05/12-propuestas-cierre.html)**
...
**Paso 5:** Instalar Ollama y descargar un modelo local. En el Día 4 vamos a ejecutar modelos de lenguaje directamente en la computadora, sin enviar datos a internet.
...
3. Si la computadora tiene menos de 8 GB de RAM, descargar la versión más liviana, que funciona igual pero ocupa menos memoria:
