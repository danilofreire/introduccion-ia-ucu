...
Es [IBM Granite](https://www.ibm.com/granite), un modelo abierto (licencia Apache 2.0) optimizado para salida estructurada en JSON y con buen soporte multilingüe. Es el que usamos para codificar texto en los laboratorios y las tareas. Ocupa unos 2,1 GB.

3. Para verificar que el modelo quedó descargado, ejecutar `ollama list`. Debería aparecer en la lista de modelos instalados:

```bash
ollama list
```

4. Para comprobar que el modelo responde, ejecutar en la terminal:
