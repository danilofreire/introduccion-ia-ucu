...
Antes de modelar, conviene ver [cómo se distribuyen las variables]{.alert} y si difieren entre los grupos de `satisfecho`:
...
[Más estadísticas en Apéndices 2 y 3; visualizaciones (incluidos boxplots) en Apéndice 4]{.alert}
:::
...
[[App 1: dim y conteos]{.button}](#sec:appendix01) · [[App 2: estadísticas]{.button}](#sec:appendix02) · [[App 3: relaciones]{.button}](#sec:appendix03) · [[App 4: visualizaciones]{.button}](#sec:appendix04)
:::
...
# Repetir el mismo bloque de antes, ahora con formula_ext
...
eval_arb_ext <- fit_resamples(
  modelo_arbol, formula_ext, resamples = folds,
  metrics = metric_set(precision, recall, roc_auc),
  control = control_resamples(event_level = "second")
) |>
  collect_metrics() |> mutate(modelo = "Árbol (ext)")

# Comparar los 4 modelos por roc_auc
...
## Apéndice 2: Estadísticas por variable {#sec:appendix02}

:::{style="margin-top: 20px; font-size: 20px;"}

```{r appendix02univar, prompt=FALSE, echo=TRUE, eval=FALSE}
...
[Cambien el nombre de la variable para explorar otras: `educacion_anos`, `consumo_noticias`, `participacion_politica`, `edad`]{.alert}

[[Volver al Ejercicio 1]{.button}](#sec:exercise01)
:::

## Apéndice 3: Relaciones con la satisfacción {#sec:appendix03}

:::{style="margin-top: 20px; font-size: 20px;"}

```{r appendix03bivar, prompt=FALSE, echo=TRUE, eval=FALSE}
...
[Las medias por grupo son la pista más rápida: si difieren mucho, la variable probablemente ayudará al modelo]{.alert}

[[Volver al Ejercicio 1]{.button}](#sec:exercise01)
:::

## Apéndice 4: Más visualizaciones {#sec:appendix04}
...
## Apéndice 4 (cont.) — Satisfacción por zona

:::{style="margin-top: 30px; font-size: 20px;"}

```{r appendix04a, prompt=FALSE, fig.width=10, fig.height=4, echo=TRUE}
