...
glm_model <- glm(Risk_binary ~ . - Risk - Sex, data = german, family = binomial)

explainer_glm <- DALEX::explain(
  glm_model,
  data = german |> select(-Risk, -Risk_binary),
  y = german$Risk_binary,
