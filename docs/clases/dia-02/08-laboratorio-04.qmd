...
:::{.callout-tip}
**Checkpoint**: deberían ver 3 filas (rmse, rsq, mae) con RMSE ≈ 1.8-2.0 y R² ≈ 0.15-0.30
:::
...
**Tarea (5 min):** completen el código para evaluar cada λ con 10-fold CV
...
:::{.callout-tip}
**Checkpoint**: deberían ver ~10 filas con `mean` (RMSE) entre 1.0 y 2.0 según el λ
:::
