...
Repitan el tuning de Random Forest del laboratorio pero con 20 folds en vez de 10. ¿El mejor modelo tiene los mismos hiperparámetros? ¿El error estándar (`std_err`) de las métricas es menor con más folds?
