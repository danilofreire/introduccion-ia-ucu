...
## Ejercicio 2: Agregar interacciones {#sec:exercise02}

:::{style="margin-top: 30px; font-size: 22px;"}

**Instrucciones:**

1. Modificar la receta para incluir interacciones (ej: `edad × educacion_anios`)
2. Ajustar LASSO con la nueva receta y comparar el RMSE con el modelo sin interacciones
3. ¿LASSO elimina las interacciones o las retiene?

*Pista:* usen `step_interact(terms = ~ edad:educacion_anios)` en la receta antes de `step_normalize()`.
...
## Ejercicio 3: Comparar con países específicos {#sec:exercise03}

:::{style="margin-top: 30px; font-size: 22px;"}

**Instrucciones:**

1. Crear una nueva receta que incluya `pais` como predictor (genera muchas dummies)
2. Ajustar LASSO con esta receta y la lambda óptima
3. ¿Cuáles países tienen coeficientes distintos de cero?
4. ¿Ayuda LASSO a seleccionar qué países importan?

*Pista:* usen `step_rm(voto)` en vez de excluir `pais` de la fórmula.
