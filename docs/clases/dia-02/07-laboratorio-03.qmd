...
modelo_rf_tune <- rand_forest(
  ...
  set_engine("ranger", importance = "impurity") |> # ranger es un motor rápido para Random Forest
  set_mode("classification")
...
:::{.callout-warning}
Gini mide [predictibilidad]{.alert}, no efecto causal: que la edad importe no significa que "envejecer causa votar"
:::
:::
:::
:::
