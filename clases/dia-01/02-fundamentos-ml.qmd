...
- [Paso 3: Dividir]{.alert} -- separar datos en conjuntos de entrenamiento y prueba
:::

:::{.column width=50%}
- [Paso 4: Entrenar]{.alert} -- ajustar un modelo a los datos de entrenamiento
- [Paso 5: Evaluar]{.alert} -- medir el rendimiento del modelo en los datos de prueba
- En la práctica, [este proceso es iterativo]{.alert}: volvemos a pasos anteriores para mejorar
:::
:::
:::
...
Un colega les muestra un modelo y les dice con orgullo: ["Logra un 99,9% de accuracy"]{.alert}
...
[La accuracy (precisión general) no es suficiente]{.alert}, especialmente con clases desbalanceadas.
:::
:::
