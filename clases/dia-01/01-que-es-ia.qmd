...
- Estos desafíos son reales, pero también hay problemas concretos donde la IA ya ayuda: triaje en hospitales públicos, detección de plagas en cultivos, scoring crediticio para personas sin historial bancario
...
- Tres innovaciones: [ajuste de instrucciones]{.alert}, [RLHF]{.alert} (aprendizaje por refuerzo con retroalimentación humana) y [entrenamiento de seguridad]{.alert}
...
[En la práctica, muchos sistemas combinan varios tipos.]{.alert} Por ejemplo, ChatGPT usa aprendizaje auto-supervisado (pre-entrenamiento con predicción del siguiente token), luego ajuste supervisado con instrucciones, y finalmente aprendizaje por refuerzo (RLHF).
...
- [Los sistemas de IA siempre pueden explicar por qué tomaron una decisión]{.alert}
    - [Depende del modelo.]{.alert} Modelos simples (regresión, árboles) sí son interpretables. Las redes neuronales profundas son "cajas negras", aunque hay métodos post hoc (SHAP, LIME) que ayudan parcialmente
...
- América Latina enfrenta desafíos concretos (pocos datasets en español, infraestructura desigual) pero ya tiene aplicaciones reales en fintech, salud pública y agricultura
:::
