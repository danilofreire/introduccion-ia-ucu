...
- Estas tareas incluyen aprender, razonar, resolver problemas, percibir y entender el lenguaje
...
- [Aprendizaje profundo]{.alert} (DP), un subconjunto de ML basado en redes neuronales
...
- [Agricultura]{.alert}: predicción de cosechas y monitoreo de deforestación
- Detección de fraude en [fintech]{.alert} (MercadoLibre, Nubank)
- En [salud]{.alert}, triaje automático en hospitales públicos
- [Justicia]{.alert}: clasificación de procesos (Uruguay, Brasil)
- Rutas optimizadas en [logística]{.alert} (Rappi)
:::

:::{.column width=50%}
**Desafíos**

- Pocos datos en español y portugués
...
- [Generación de texto]{.alert}: resúmenes, traducción y código
- [Análisis de imágenes]{.alert} para diagnóstico médico y reconocimiento facial
- [Predicción]{.alert} de demanda o riesgo crediticio
- [Automatización]{.alert} en atención al cliente y clasificación de documentos

**Lo que todavía le cuesta**

- El [razonamiento causal]{.alert}: entender el porqué, no solo las correlaciones
- El [sentido común]{.alert}, eso que para nosotros es obvio
- La [explicabilidad]{.alert} de sus propias decisiones
:::

:::{.column width=45%}
**Tendencias actuales**

- Modelos cada vez más [grandes]{.alert}, con rendimientos decrecientes
- Énfasis en la [eficiencia]{.alert}: modelos pequeños y rápidos
- [Multimodalidad]{.alert} (texto, imagen, audio y video)
- [Agentes]{.alert} autónomos para tareas complejas
- Debate sobre [IA abierta y cerrada]{.alert} y el acceso a los modelos

<br>

[Momento de experimentación activa: nadie sabe exactamente a dónde va esto]{.alert}
:::
:::
:::
...
- [Mantenimiento costoso]{.alert}, [cuello de botella del conocimiento]{.alert}, [no aprendían]{.alert}
...
- [Traducción zero-shot]{.alert} entre idiomas que nunca vio juntos
- Escribir [código]{.alert} en múltiples lenguajes
- [Seguir instrucciones complejas]{.alert}

- Nadie las diseñó: [emergieron del entrenamiento a escala]{.alert}
:::

:::{.column width=45%}
**Implicancia**

- No podemos predecir qué hará un modelo nuevo
- La evaluación post-hoc es necesaria
- Las capacidades pueden aparecer (o desaparecer) con la escala

<br>

[¿Cómo predecir y controlar capacidades emergentes? Es un área de investigación activa]{.alert}
:::
:::
:::
