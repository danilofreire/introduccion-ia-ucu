...
:::{.columns}
:::{.column width=55%}
- **Verano de 1956**: un [taller en Dartmouth College](https://en.wikipedia.org/wiki/Dartmouth_workshop) marca el nacimiento de la IA como campo de estudio
- Organizado por [John McCarthy](https://en.wikipedia.org/wiki/John_McCarthy), [Marvin Minsky](https://en.wikipedia.org/wiki/Marvin_Minsky), [Nathaniel Rochester](https://en.wikipedia.org/wiki/Nathaniel_Rochester_(computer_scientist)) y [Claude Shannon](https://en.wikipedia.org/wiki/Claude_Shannon)
...
- [Problemas reales:]{.alert} sesgo y alucinaciones
:::
