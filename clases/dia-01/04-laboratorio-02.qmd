...
- En este ejemplo, [`alto_desempleo`]{.alert} cambia las métricas del logístico apenas unas milésimas, dentro del error estándar
- En el [Ejercicio 3]{.alert} van a repetir esto con los dos modelos y su propia variable
- La lección: no todo feature engineering mejora el modelo. Cuando el predictor original ya capta la información, agregarle un recorte categórico es redundante. Hay que [medirlo]{.alert}, no asumirlo
:::
