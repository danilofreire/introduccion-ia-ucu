...
**Respuesta:** No hay una única respuesta correcta; lo que se evalúa es el razonamiento. Una respuesta sólida reconoce que el modelo sí aporta valor (supera la línea base de ≈0.51 con una accuracy de ≈0.76 y un AUC de ≈0.86, un nivel "bueno"), pero también que no es perfecto: con un recall de ≈0.72 se le escapa cerca de un tercio de los países que sí crecen.

Para un escenario de inversión, un falso positivo (invertir en un país que no crece) cuesta dinero directo, así que conviene priorizar la **precisión** y, si hace falta, subir el umbral de decisión (como vieron en la Pregunta 9) para reducir falsos positivos a costa de algo de recall. Una recomendación honesta sería: el modelo es un punto de partida razonable para ordenar prioridades, pero no para decidir de forma automática; las decisiones de inversión deberían combinar su salida con juicio experto, sobre todo en los países donde la probabilidad predicha queda cerca de 0.5.
