...
Elige dos países del dataset que te interesen. Compara sus valores en las 8 variables.

```{r}
#| label: ejercicio-dos-paises
#| echo: true
#| eval: true
...
¿Cuál parece más [desarrollado]{.alert}? ¿En qué variable es mayor la diferencia? Prueba con otros pares (por ejemplo, Chile vs. Bolivia, Argentina vs. Venezuela).
:::
...
¿La silueta sube o baja? Mira qué países quedan en el cluster "intermedio": ¿tiene sentido como "desarrollo medio"?

[Con K=2 la silueta es 0.289; con K=3 es 0.272. La diferencia es chica, pero K=2 gana.]{.alert}
:::
...
¿Coincide el ranking con tu intuición? ¿Qué país te sorprende más (arriba o abajo)?
:::
