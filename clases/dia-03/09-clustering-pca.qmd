...
- PCA produce [tantos componentes como variables originales]{.alert}. Criterios para conservar los primeros: [varianza acumulada ~70-80%]{.alert}, [método del codo]{.alert}, [regla de Kaiser]{.alert} (eigenvalue > 1)
...
Apéndices: [[caracterizar clusters]{.button}](#sec:apendice-cluster) · [[PCA vs. análisis factorial]{.button}](#sec:apendice-fa)
:::
:::
...
:::{.column width=45%}
**2. Validación externa:** cruzar con variables [no usadas]{.alert} en el clustering (región, partido, año). Si los grupos separan esas variables, tenés evidencia de estructura real
...
[Regla práctica:]{.alert} si vas a reportar un índice como "medida de X" (un constructo o actitud), querés análisis factorial. Si solo necesitás reducir dimensiones para visualizar, PCA alcanza
