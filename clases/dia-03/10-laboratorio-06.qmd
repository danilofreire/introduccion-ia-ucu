...
| 2 | Frecuencias y TF-IDF | ~15 min |
| 3 | Topic Modeling (LDA) | ~20 min |
| 4 | Ejercicios | ~10 min |

<br>

[Los textos están etiquetados por tema. Vamos a ver si los métodos recuperan esas etiquetas. Material extra en los apéndices.]{.alert}
:::
...
[Mañana veremos cómo los LLMs superan estas limitaciones. Material extra en los apéndices.]{.alert}
:::

# Apéndice 1: Nube de palabras {background-color="#2d4563"}
...
# Apéndice 2: Validación visual de LDA {background-color="#2d4563"}
...
ggplot(validacion_long, aes(x = factor(topic), y = tema, fill = gamma_promedio)) +
  ...
  labs(title = "Correspondencia entre temas reales y temas LDA",
       x = "Tema LDA", y = "Tema real", fill = "Gamma\npromedio") +
  theme_minimal()
```
:::
...
# Apéndice 3: Ejercicio opcional {background-color="#2d4563"}

## Ejercicio: análisis de sentimiento simple
