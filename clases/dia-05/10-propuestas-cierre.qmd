...
subtitle: "Sesión 5.2: Mini-propuestas de investigación y cierre"
author:
  - name: Danilo Freire
...
format:
  clean-revealjs:
    self-contained: true
    footer: "[Sesión 5.2](https://danilofreire.github.io/introduccion-ia-ucu/clases/dia-05/10-propuestas-cierre.html)"
    transition: slide
...
| Explicar causalidad | [No usar ML]{.alert} (usar experimentos, DiD, IV) |
:::
:::
:::
...
- Gracias a todos ustedes por su [participación]{.alert}, sus preguntas y su entusiasmo
- Ha sido un placer compartir estos cinco días con ustedes
- Les deseo lo mejor en sus investigaciones y carreras
- [Sigan curiosos y sigan aprendiendo]{.alert}
:::
