...
- La lección: [más complejo no es sinónimo de mejor]{.alert}. Con datos reales, más ruidosos y no lineales, el orden suele invertirse. Por eso [siempre hay que comparar]{.alert} antes de elegir
:::
...
- Si necesitan la [mejor predicción posible]{.alert}: Random Forest o Gradient Boosting, pero sólo si los datos tienen estructura no lineal que aprovechar
