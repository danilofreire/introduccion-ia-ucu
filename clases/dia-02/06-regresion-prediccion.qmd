...
- OLS asigna coeficientes sin límite → sobreajuste con muchas variables
- Regularización impone un [presupuesto]{.alert}: el modelo reparte un total finito entre todas las variables, y $\lambda$ fija cuán ajustado es ese presupuesto
:::
:::
:::
...
## Apéndice 1: Ejemplo - Satisfacción con la democracia
...
## Apéndice 2: Regularización en alta dimensionalidad
