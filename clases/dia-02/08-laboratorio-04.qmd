...
:::{.callout-tip}
**Checkpoint**: deberían ver 3 filas (rmse, rsq, mae) con RMSE ≈ 1.1-1.3 y R² ≈ 0.20-0.30
:::
...
:::{.callout-tip}
**Checkpoint**: deberían ver ~10 filas con `mean` (RMSE) alrededor de 1.2 (sube si λ es muy grande)
:::
...
:::{.callout-tip}
**Checkpoint**: con λ alrededor de 0.03, deberían ver unas 3 variables con coeficiente exactamente 0 (eliminadas por LASSO)
:::
...
:::{.callout-tip}
**Checkpoint**: Ridge debería eliminar **0 variables** (puede mostrar valores como `1e-10`, que son prácticamente cero pero no exactos). RMSE similar a LASSO (~1.1-1.3)
:::
...
- RMSE ≈ 1.19 — en promedio la predicción se aleja de la realidad en ~1.2 puntos (escala 1-10)
