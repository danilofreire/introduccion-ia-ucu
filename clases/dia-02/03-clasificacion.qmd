...
:::{.columns}
:::{.column width=50%}
**[Muchlinski et al. (2016)](https://doi.org/10.1093/pan/mpv024)**
...
- Pero: [Wang (2019)](https://doi.org/10.1093/pan/mpz004) replicó el estudio y encontró errores en el código; con datos corregidos, la ventaja de RF era menor
- La lección sigue siendo válida: RF puede capturar interacciones complejas que la regresión logística no capta
:::
