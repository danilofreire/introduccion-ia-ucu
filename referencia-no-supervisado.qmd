...
Esta página es una referencia rápida de los comandos de [clustering]{.alert} y [PCA]{.alert} que usamos en la Sesión 3.1 y en el Laboratorio 5. Todos los ejemplos son ejecutables con datos simulados. Pueden copiar y pegar el código en RStudio para practicar.
...
K-means y PCA requieren una [matriz numérica escalada]{.alert}. Guardamos los nombres de grupo aparte para usarlos en la validación.
